...
public class Player_Page extends FragmentActivity {

  private static final String TAG = Player_Page.class.getSimpleName();

  private static final String CLIENT_ID = "38047c55e4114e78819dcb62fe4b279a";
  private static final String REDIRECT_URI = "crowdbeat://callback";
  ...
  private static final String PLAYLIST_URI = "spotify:playlist:20ChvH1XTIcL1Q6mVQyPu2";
  ...
  private final Subscription.EventCallback<PlayerContext> mPlayerContextEventCallback =
          new Subscription.EventCallback<>() {
              @Override
    ...
    SpotifyAppRemote.connect(
        ...
        new Connector.ConnectionListener() {
          ...
          public void onConnected(SpotifyAppRemote spotifyAppRemote) {
            ...
            Player_Page.this.onConnected();
          }

          @Override
          public void onFailure(Throwable error) {
            logError(error);
            Player_Page.this.onDisconnected();
          }
        });
  }
